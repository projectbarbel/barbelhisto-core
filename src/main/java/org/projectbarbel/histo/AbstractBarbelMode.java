...
/**
 * The two distinct {@link AbstractBarbelMode} variants. Implements the state specific
 * behavior.
 * 
 * @author Niklas Schlimm
 *
 */
public abstract class AbstractBarbelMode {
    ...
    public static class PojoMode extends AbstractBarbelMode {
    ...
    public static class BitemporalMode extends AbstractBarbelMode {
